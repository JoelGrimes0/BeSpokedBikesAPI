...
namespace BeSpokedBikesAPI.Migrations
{
    ...
    [Migration("20250309050919_AddUserTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeSpokedBikesAPI.Models.Product", b =>
                {
                    ...
                    b.HasIndex("Name", "Manufacturer", "Style")
                        .IsUnique()
                        .HasFilter("[Name] IS NOT NULL AND [Manufacturer] IS NOT NULL AND [Style] IS NOT NULL");
            ...
            modelBuilder.Entity("BeSpokedBikesAPI.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
